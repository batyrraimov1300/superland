...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.totalEachItem.setText(Math.round((listFoodSelected.get(position).getNumberInCard() * listFoodSelected.get(position).getFee()))+ " ₽");
        holder.num.setText(String.valueOf(listFoodSelected.get(position).getNumberInCard()));
